...
import video.api.client.api.work.UploadWorkerManagerHelper;
...
public class UploadWorkerTest {
    ...
    class Upload {
        ...
        public void uploadVideo() throws IOException, InterruptedException {
            ...
            OperationWithRequest operationWithRequest = UploadWorkerManagerHelper.upload(workManager, testVideo.getVideoId(), mp4File);
        ...
        public void uploadVideoWithError() throws IOException, InterruptedException {
            ...
            OperationWithRequest operationWithRequest = UploadWorkerManagerHelper.upload(workManager, "WRONG VIDEO ID", mp4File);
            InstrumentationRegistry.getInstrumentation().runOnMainSync(() ->
                    workManager.getWorkInfoByIdLiveData(operationWithRequest.getRequest().getId()).observeForever(workInfo -> {
                        if (workInfo != null) {
    ...
    class UploadWithUploadToken {
        ...
        public void uploadVideo() throws IOException, InterruptedException {
            ...
            OperationWithRequest operationWithRequest = UploadWorkerManagerHelper.uploadWithUploadToken(workManager, testUploadToken.getToken(), mp4File, null);
            InstrumentationRegistry.getInstrumentation().runOnMainSync(() ->
                    workManager.getWorkInfoByIdLiveData(operationWithRequest.getRequest().getId()).observeForever(workInfo -> {
                        if (workInfo != null) {
                            if (workInfo.getState() == WorkInfo.State.SUCCEEDED) {
    ...
    class ProgressiveUpload {
        ...
        public void uploadVideo() throws IOException, InterruptedException {
            ...
            OperationWithRequest operationWithRequest1 = UploadWorkerManagerHelper.uploadPart(workManager, uploadProgressiveSession, part1, false);
            OperationWithRequest operationWithRequest2 = UploadWorkerManagerHelper.uploadPart(workManager, uploadProgressiveSession, part2, false);
            OperationWithRequest operationWithRequest3 = UploadWorkerManagerHelper.uploadPart(workManager, uploadProgressiveSession, part3, true);
