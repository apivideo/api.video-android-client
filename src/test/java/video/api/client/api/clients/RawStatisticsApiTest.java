...
public class RawStatisticsApiTest extends AbstractApiTest {
    ...
    class listLiveStreamSessions {
        ...
        public void requiredParametersTest() {
            ...
            assertThat(e).hasMessageThat()
                    .contains("Missing the required parameter 'liveStreamId' when calling listLiveStreamSessions");
        ...
        public void responseWithStatus200Test() throws ApiException {
            ...
            assertThat(page.getItems()).containsExactlyElementsIn(Collections.singletonList(new LiveStreamSession()
                    .session(new LiveStreamSessionSession().sessionId("ps4zRWVOv2If2vzKJLMr3jQo")
                            .loadedAt(parse("2018-09-11T13:04:37.89Z")).endedAt(parse("2018-09-11T14:47:22.186Z")))
                    ...
                    .client(new LiveStreamSessionClient().type("browser").name("Firefox").version("61.0")))).inOrder();
        }
        ...
        public void responseWithStatus404Test() throws ApiException {
            ...
            ApiException e = assertThrows(ApiException.class,
                    () -> api.listLiveStreamSessions("vi4k0jvEUuaTdRAEjQ4Jfrgz").execute());
    ...
    class listSessionEvents {
        ...
        public void requiredParametersTest() {
            ...
            assertThat(e).hasMessageThat()
                    .contains("Missing the required parameter 'sessionId' when calling listSessionEvents");
        ...
        public void responseWithStatus200Test() throws ApiException {
            ...
            assertThat(page.getItems()).containsExactlyElementsIn(Arrays.asList(
                    new PlayerSessionEvent().type("ready").emittedAt(parse("2020-09-15T09:47:42+00:00")).at(0),
                    new PlayerSessionEvent().type("play").emittedAt(parse("2020-09-15T21:35:57+00:00")).at(0),
                    new PlayerSessionEvent().type("pause").emittedAt(parse("2020-09-15T21:36:05+00:00")).at(7),
                    new PlayerSessionEvent().type("resume").emittedAt(parse("2020-09-15T21:36:19+00:00")).at(21),
                    new PlayerSessionEvent().type("seek.forward").emittedAt(parse("2020-09-15T21:36:19+00:00")).from(7)
                            .to(21),
                    new PlayerSessionEvent().type("end").emittedAt(parse("2020-09-15T21:36:28+00:00")).at(30),
                    new PlayerSessionEvent().type("play").emittedAt(parse("2020-09-15T21:36:29+00:00")).at(0),
                    new PlayerSessionEvent().type("seek.backward").emittedAt(parse("2020-09-15T21:36:29+00:00"))
                            .from(30).to(0),
                    new PlayerSessionEvent().type("pause").emittedAt(parse("2020-09-15T21:36:29+00:00")).at(21),
                    new PlayerSessionEvent().type("resume").emittedAt(parse("2020-09-15T21:36:30+00:00")).at(21),
                    new PlayerSessionEvent().type("seek.forward").emittedAt(parse("2020-09-15T21:36:30+00:00")).from(0)
                            .to(21),
                    new PlayerSessionEvent().type("pause").emittedAt(parse("2020-09-15T21:36:33+00:00")).at(20),
                    new PlayerSessionEvent().type("resume").emittedAt(parse("2020-09-15T21:36:33+00:00")).at(20),
                    new PlayerSessionEvent().type("seek.backward").emittedAt(parse("2020-09-15T21:36:33+00:00"))
                            .from(24).to(20),
                    new PlayerSessionEvent().type("pause").emittedAt(parse("2020-09-15T21:36:39+00:00")).at(17),
                    new PlayerSessionEvent().type("resume").emittedAt(parse("2020-09-15T21:36:39+00:00")).at(17),
                    new PlayerSessionEvent().type("seek.forward").emittedAt(parse("2020-09-15T21:36:39+00:00")).from(17)
                            .to(17),
                    new PlayerSessionEvent().type("pause").emittedAt(parse("2020-09-15T21:36:41+00:00")).at(19),
                    new PlayerSessionEvent().type("ready").emittedAt(parse("2020-09-17T09:20:47+00:00")).at(0),
                    new PlayerSessionEvent().type("ready").emittedAt(parse("2020-09-17T09:41:01+00:00")).at(0),
                    new PlayerSessionEvent().type("ready").emittedAt(parse("2020-09-17T09:41:08+00:00")).at(0),
                    new PlayerSessionEvent().type("play").emittedAt(parse("2020-09-17T09:41:10+00:00")).at(0),
                    new PlayerSessionEvent().type("pause").emittedAt(parse("2020-09-17T09:41:12+00:00")).at(1),
                    new PlayerSessionEvent().type("resume").emittedAt(parse("2020-09-17T09:41:13+00:00")).at(1),
                    new PlayerSessionEvent().type("pause").emittedAt(parse("2020-09-17T09:41:15+00:00")).at(3)))
                    .inOrder();
        }
        ...
        public void responseWithStatus404Test() throws ApiException {
            ...
            ApiException e = assertThrows(ApiException.class,
                    () -> api.listSessionEvents("psEmFwGQUAXR2lFHj5nDOpy").execute());
            assertThat(e.getCode()).isEqualTo(404);
            assertThat(e).hasMessageThat().contains("The requested resource was not found.");
        }
    }
    ...
    class listVideoSessions {
        ...
        public void requiredParametersTest() {
            ...
            assertThat(e).hasMessageThat()
                    .contains("Missing the required parameter 'videoId' when calling listVideoSessions");
        ...
        public void responseWithStatus200Test() throws ApiException {
            ...
            assertThat(page.getItems()).containsExactlyElementsIn(Arrays.asList(new VideoSession()
                    .session(new VideoSessionSession().sessionId("psEmFwGQUAXR2lFHj5nDOpy")
                            .loadedAt(parse("2019-06-24T11:45:01.109Z")).endedAt(parse("2019-06-24T11:49:19.243Z")))
                    ...
                    .client(new VideoSessionClient().type("browser").name("Firefox").version("67.0")))).inOrder();
        }
        ...
        public void responseWithStatus404Test() throws ApiException {
            ...
            ApiException e = assertThrows(ApiException.class,
                    () -> api.listVideoSessions("vi4k0jvEUuaTdRAEjQ4Prklg").execute());
            assertThat(e.getCode()).isEqualTo(404);
            assertThat(e).hasMessageThat().contains("The requested resource was not found.");
        }
    }
