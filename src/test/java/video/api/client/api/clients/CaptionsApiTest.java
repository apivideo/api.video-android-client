...
public class CaptionsApiTest extends AbstractApiTest {
    ...
    class update {
        ...
        public void requiredParametersTest() {
            ...
            ApiException e = assertThrows(ApiException.class,
                    () -> api.update(null, "en", new CaptionsUpdatePayload()));
            ...
            assertThat(e).hasMessageThat()
                    .contains("Missing the required parameter 'captionsUpdatePayload' when calling update");
    ...
    class upload {
        ...
        public void responseWithStatus400Test() throws ApiException {
            ...
            ApiException e = assertThrows(ApiException.class,
                    () -> api.upload("vi4k0jvEUuaTdRAEjQ4Prklg", "en", new File("")));
            assertThat(e.getCode()).isEqualTo(400);
            assertThat(e).hasMessageThat().contains("");
        }
