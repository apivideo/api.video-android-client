...
public class UploadTokensApiTest extends AbstractApiTest {
    ...
    class deleteToken {
        ...
        public void requiredParametersTest() {
            ...
            assertThat(e).hasMessageThat()
                    .contains("Missing the required parameter 'uploadToken' when calling deleteToken");
    ...
    class getToken {
        ...
        public void requiredParametersTest() {
            ...
            assertThat(e).hasMessageThat()
                    .contains("Missing the required parameter 'uploadToken' when calling getToken");
    ...
    class createToken {
        ...
        public void requiredParametersTest() {
            ...
            assertThat(e).hasMessageThat()
                    .contains("Missing the required parameter 'tokenCreationPayload' when calling createToken");
