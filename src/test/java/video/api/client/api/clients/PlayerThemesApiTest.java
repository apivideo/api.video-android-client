...
public class PlayerThemesApiTest extends AbstractApiTest {
    ...
    class update {
        ...
        public void requiredParametersTest() {
            ...
            assertThat(e).hasMessageThat()
                    .contains("Missing the required parameter 'playerUpdatePayload' when calling update");
        ...
        public void responseWithStatus404Test() throws ApiException {
            ...
            ApiException e = assertThrows(ApiException.class,
                    () -> api.update("pl45d5vFFGrfdsdsd156dGhh", new PlayerThemeUpdatePayload()));
            assertThat(e.getCode()).isEqualTo(404);
            assertThat(e).hasMessageThat().contains("The requested resource was not found.");
        }
    }
    ...
    class create {
        ...
        public void requiredParametersTest() {
            ...
            assertThat(e).hasMessageThat()
                    .contains("Missing the required parameter 'playerCreationPayload' when calling create");
    ...
    class uploadLogo {
        ...
        public void requiredParametersTest() {
            ...
            assertThat(e).hasMessageThat()
                    .contains("Missing the required parameter 'playerId' when calling uploadLogo");
        ...
        public void responseWithStatus400Test() throws ApiException {
            ...
            ApiException e = assertThrows(ApiException.class,
                    () -> api.uploadLogo("pl14Db6oMJRH6SRVoOwORacK", new File(""), "file_example"));
            assertThat(e.getCode()).isEqualTo(400);
            assertThat(e).hasMessageThat()
                    .contains("Only ['jpg', 'JPG', 'jpeg', 'JPEG', 'png', 'PNG'] extensions are supported.");
        }
