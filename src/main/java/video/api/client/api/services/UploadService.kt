...
import video.api.client.api.notifications.NotificationUtils.DEFAULT_NOTIFICATION_ID
import video.api.client.api.notifications.NotificationUtils.DEFAULT_NOTIFICATION_SERVICE_CHANNEL_ID
...
open class UploadService(
    ...
    protected val notificationUtils: ServiceNotificationUtils by lazy {
        ServiceNotificationUtils(this, channelId, notificationId)
    }
    ...
    fun createUploadTokenProgressiveUploadSession(token: String, videoId: String? = null) =
        createProgressiveUploadSession(
            videosApi.createUploadWithUploadTokenProgressiveSession(
                token,
                videoId
            )
        )
